...
import { colors } from "@mui/material";
 import "./Model.css"
  ...
  return (
    <div className="modalmedia flex justify-center fixed inset-0 bg-black text-white z-10 bg-opacity-30 backdrop-blur-sm sm:flex Sm:justify-center items-center ">
